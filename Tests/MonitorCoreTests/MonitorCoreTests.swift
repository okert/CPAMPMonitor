...
final class MonitorCoreTests {
    ...
    func testAccountOrderMigratesAndRoundTrips() {
        ...
        current.displayWindowID = "weekly"
        ...
        expectEqual(roundTrip.displayWindowID, current.displayWindowID)
        ...
        expectEqual(QuotaWindow.minimumFreshRemaining(selected, id: "weekly", now: now, maxAge: 600), 37)
        expectNil(QuotaWindow.minimumFreshRemaining(selected, id: "five-hour", now: now, maxAge: 600))
